...
async def async_setup_entry(
    ...
    entities.append(USPSAwaitingPickupSensor(coordinator, entry))
...
class USPSAwaitingPickupSensor(CoordinatorEntity[USPSCoordinator], SensorEntity):
    """Tracked parcels held at a post office or ready for pickup."""
